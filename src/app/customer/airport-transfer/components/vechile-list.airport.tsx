...
import { Luggage, Ticket, TicketCheck, User } from "lucide-react";
  ...
  return (
    <>
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-3 flex flex-col gap-4 md:sticky md:top-[18%] md:max-h-[550px] md:overflow-auto">
              ...
              recomendedVechiles.map((vechile, key) => (
                ...
                >
                  ...
                  <div className="col-span-12 md:col-span-6 flex flex-col gap-1">
                    ...
                    <div>
                      <span>{vechile.short_description}</span>
                    </div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>You will get a free waiting time of {vechile.driver_free_waiting_time_in_minutes} minutes!</p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    </div>
                  ...
                  <div className="col-span-12 md:col-span-3 my-auto">
                    <div className="flex ml-auto w-1/2 md:ml-0 md:w-full items-center justify-center md:flex-col gap-2">
                      ...
                      <Button
                        ...
                        variant="default"
                        className="ml-auto rounded-lg flex-1 w-[80px] px-8 md:px-3 lg:px-6 py-2 h-6 bg-gradient-to-r bg-[#65AD2E] hover:bg-[#65AD2E]/80 text-white font-bold  transition-transform transform-gpu hover:-translate-y-1 hover:shadow-lg"
                      >
                        Add car
                      </Button>
                    </div>
