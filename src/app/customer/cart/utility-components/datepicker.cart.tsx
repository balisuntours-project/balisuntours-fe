...
export function DatePickerCart({
  orderId,
  diffDays,
  defaultSelectedDate,
}: {
  ...
  const setScopedState = useDatePickerScopedStore(
  ...
  const handleDateSelect = (selectedDate: Date | undefined) => {
    if (selectedDate) {
      ...
      const formattedDate =
        GlobalUtility.SetFormattedStandartDate(selectedDate);
  ...
  useEffect(() => {
    if (defaultSelectedDate) {
      const formattedDate =
        GlobalUtility.SetFormattedStandartDate(defaultSelectedDate);
