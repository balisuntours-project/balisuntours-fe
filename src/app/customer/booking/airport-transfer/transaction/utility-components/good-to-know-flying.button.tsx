...
export function GoodToKnowFlying() {
  return (
    <div className="fixed bottom-4 right-4 h-14 w-14 rounded-full bg-blue-600 text-white md:hidden flex items-center justify-center shadow-lg hover:bg-blue-700 transition">
      <DynamicDialog
