            ...
            <div className="p-6">
              <div className="grid grid-cols-5 gap-5 lg:items-start">
                <div className="flex flex-col gap-2 lg:ml-auto col-span-5 lg:col-span-2 lg:order-2">
                  <PaymentStatusBooking status={booking.booking_info.status} />
                ...
                <div className="flex flex-col gap-4 col-span-5 lg:flex-row lg:col-span-3 lg:order-1">
                  <div className="flex flex-col gap-2">
                    ...
                    <span className="text-sm text-gray-500 block">
                      From:{" "}
                      <Link
                        href={`https://www.google.com/maps?q=${booking.booking_detail.origin_coordinate.lat},${booking.booking_detail.origin_coordinate.lng}`}
                    ...
                    <span className="text-sm text-gray-500 block">
                      To:{" "}
                      <Link
                        href={`https://www.google.com/maps?q=${booking.booking_detail.destination_coordinate.lat},${booking.booking_detail.destination_coordinate.lng}`}
                        target="_blank" // Buka di tab baru
                        rel="noopener noreferrer" // Keamanan untuk tab baru
                        className="text-blue-500 hover:underline"
                      >
