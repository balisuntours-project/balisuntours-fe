...
export function CommentReviewer(props: {review: ActivityReviewResponse, forPopUp?: boolean}) {
               ...
               <div className="flex gap-1">
                 <ProfilePictureReviewer review={props.review} />
                  ...
                  <div className="flex flex-col justify-center">
                    <div className="flex flex-col lg:flex-row md:gap-1 -mb-1 md:mb-0">
                      <span className={`font-bold text-sm md:text-base ${props.forPopUp && 'text-white'}`}>
                        {props.review.name}
                      </span>
                ...
                {props.review.comment && (
                  <div className="text-sm md:text-base">
                    <p className={`${props.forPopUp ? 'text-white' : 'text-ellipsis line-clamp-4 md:line-clamp-5'}`}>
                      {props.review.comment}
                    </p>
