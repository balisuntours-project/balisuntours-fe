...
export function LandingPageSearchBoxUtility() {
  ...
  useEffect(() => {
   ...
   useEffect(() => {
    ...
    return (
        <>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 md:-translate-y-1/4 lg:-translate-y-1/2 w-[80%] md:w-[100%] bg-opacity-90 text-center p-6 z-10">
        <h2 className="text-2xl md:text-5xl font-semibold text-white">Sleep Doesn’t Help If Your Soul That’s Tired,</h2>
        <p className="text-lg md:text-xl text-white mt-3">Let’s Book Tours and Activities.</p>
        ...
        <div className="relative mt-6 md:w-[70%] lg:w-[40%] mx-auto ">
          ...
          <Input
            ...
            className="pl-10 pr-20 w-full bg-white h-12 rounded-lg"
          />

          {/* Search Button */}
          <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-[#008000] text-white px-4 py-2 rounded-lg text-sm font-semibold">
            Search
          </button>
        </div>
      </div>
