      ...
      <a target="_blank">
        ...
        >
          ...
          <CardContent className="flex flex-col h-full p-4">
            {onlyContent ? (
              <span className="text-xs md:text-sm text-[#D65600] font-semibold">
                Most Booked Adventure Tour
              </span>
            ) : (
              <span className="hidden md:block text-xs md:text-sm text-[#D65600] font-semibold">
                Most Booked Adventure Tour
              </span>
            )}
            {/* Title */}
