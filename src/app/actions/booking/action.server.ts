...
export class BookingServerAction {
  ...
  static async GetTransactionBookingData(): Promise<
    BookingActionResponse<BookingResponse>
  > {
    try {
      const action = await apiServer(`/api/customer/booking/transaction`, {
        method: "GET",
      });
      ...
      const result = this.handleResponse<BookingResponse>(action);
  ...
  static async GetWaitingBookingData(): Promise<
    BookingActionResponse<BookingResponse>
  > {
    try {
      const action = await apiServer(`/api/customer/booking/waiting`, {
        method: "GET",
      });
